    ...
    <PageContainer>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="sticky top-0 z-20 backdrop-blur bg-white/80 border-b">
          <div className="max-w-6xl mx-auto px-4 py-4 space-y-3">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-3">
                <h1 className="text-xl md:text-2xl font-bold text-gray-800">
                  <span className="text-xl md:text-2xl font-bold  bg-gradient-to-r from-[#9f2a25] via-[#c1342d] to-[#e0473f] bg-clip-text text-transparent">
                    Photo Gallery
                  </span>
                </h1>
            ...
            <div className="flex items-center gap-3 overflow-x-auto no-scrollbar py-1">
              ...
              {["All", "5K", "10K", "Half Marathon", "Full Marathon"].map(
                (f) => {
        ...
        {!loading && photos.length === 0 && (
          <div className="text-center py-10 text-gray-400">No photos found</div>
        )}
          ...
          {activeIndex !== null && photos[activeIndex] && (
            ...
            >
              ...
              <motion.img
                ...
                src={
                  photos[activeIndex].mediumUrl || photos[activeIndex].imageUrl
                }
                initial={{ scale: 0.9 }}
                animate={{ scale: 1 }}
