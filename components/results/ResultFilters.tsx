...
export default function ResultFilters({ eventId, onChange }: Props) {
  ...
  <div className="min-w-[170px]">
    <AnimatedDropdown
      ...
      onChange={setGender}
      options={[
        { label: "Overall", value: "overall", icon: <UserIcon className="w-4 h-4" /> },
        { label: "Male", value: "male", icon: <UserIcon className="w-4 h-4" /> },
        { label: "Female", value: "female", icon: <UserIcon className="w-4 h-4" /> },
      ]}
    />
  </div>
  ...
  <div className="min-w-[170px]">
    <AnimatedDropdown
      ...
      options={[
        { label: "Overall", value: "overall", icon: <TagIcon className="w-4 h-4" /> },
        ...categories.map((c) => ({
          label: c,
          value: c,
